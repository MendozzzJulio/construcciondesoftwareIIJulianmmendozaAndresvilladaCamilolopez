...
public enum Role {
	RH,                //únicos autorizados para **crear y eliminar** usuarios(Users y Patients) nuevos en la aplicación* administrar el acceso y los permisos de los usuarios* NO DEBEN PODER VISUALISAR INFORMACION DE PACIENTES, MEDICAMENTOS NI PROCEDIMIENTOS 
